									...
									<div class="col-lg-12 ">
										<div class="page-login">
											<div id="login">
												...
												<form accept-charset="utf-8" action="dangki" id="customer_register" method="post">
												...
												<div class="form-signup clearfix">
													<div class="row">
														...
														<div class="col-md-6">
															<fieldset class="form-group">
																...
																<input type="text" class="form-control form-control-lg" value="" name="tentaikhoan" id="firstName" placeholder="" required="">
															</fieldset>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-6">
															<fieldset class="form-group">
																...
																<input type="text" class="form-control form-control-lg" value="" name="tenkhachhhang"  placeholder="" required="">
															</fieldset>
														</div>
													</div>
													<div class="row">
														...
														<div class="col-md-6">
															<fieldset class="form-group">
																...
																<input type="text"  name="sdt" id="phone" pattern="^[0-9]{10}" class="form-control form-control-lg" required="">
															</fieldset>
														</div>
														<div class="col-md-6">
													...
													<div class="col-xs-12 text-xs-left" style="margin-top:30px; padding: 0">
														<button type="summit" value="Đăng ký" class="btn btn-style btn-primary-2" onclick="thongbao">Đăng ký</button>
