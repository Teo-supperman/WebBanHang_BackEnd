			...
			<div class="mother-grid-inner">
				...
				<div class="inner-block">
					<div class="product-block">
						<div class="pro-head">
							<h1 class="text-center text-danger">DANH SÁCH CHI TIẾT ĐƠN HÀNG</h1>
							<a href='<c:url value="./DonHang"></c:url>'
								class="btn btn-danger btn-lg"
								style="background-color: midnightblue; padding: 5px; font-family: tahoma; font-weight: bold; font-size: 14pt;">Trở về
								</a>
						</div>
						<div class="pro-head">
							<br>
						...
						<table class="tg" style="width: 100%;">
							<tr>
								...
								<!-- 								<th width="80">Cập nhật số lượng</th> -->
								<th width="120">Thành tiền</th>
								<!-- 								<th width="120">Delete</th> -->
							</tr>
							<c:forEach var="ct" items="${CTDonList}">
								<tr>

									<td>${ct.sp.tenSP}</td>
									<td>${ct.soLuong}</td>
									<td><fmt:formatNumber value="${ct.sp.donGia}"
											pattern="#,### đ"></fmt:formatNumber></td>
									<%-- 									<td><a href='<c:url value="showCT?id=${ma }&&ctid=${ct.id }"></c:url>' --%>
									<!-- 										class="btn btn-primary">Cập nhật</a></td> -->
									<td><fmt:formatNumber value="${ct.soLuong*ct.sp.donGia}"
											pattern="#,### đ"></fmt:formatNumber></td>
								</tr>
							</c:forEach>
						</table>
