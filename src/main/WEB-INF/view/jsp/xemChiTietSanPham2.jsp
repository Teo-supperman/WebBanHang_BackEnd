			...
			<div class="mother-grid-inner">
				...
				<div class="inner-block">
					<div class="product-block">
						<div class="pro-head">
							<h1 class="text-center text-danger">THÔNG TIN
								SẢN PHẨM</h1>
							<br> <a href='<c:url value="../SanPham"></c:url>'
								class="btn btn-danger btn-lg"
								style="background-color: midnightblue; padding: 5px; font-family: tahoma; font-weight: bold; font-size: 14pt;">Trở
								về</a><br> <br>
						</div>
						<div class="container">
							<div class="row">
								...
								<div class="col-xl-6 col-lg-6 col-md-12">
									<div
										class="product-details-content main-product-details-content">
										<h2>${sp.tenSP}</h2>

										<span style="font-size: 15pt;"><b>Loại sản phẩm:</b>
											${sp.loai.tenLoaiSP}</span> <br><br> <span style="font-size: 15pt;"><b>Đơn
												giá:</b> ${sp.donGia}đ</span><br> <br> <span style="font-size: 15pt;"><b>Mô
												tả sản phẩm:</b> ${sp.moTa}</span> <br>
									</div>
								</div>
							</div>
						</div>
