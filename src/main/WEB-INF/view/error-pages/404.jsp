...
<head>
    ...
    <title>Dking - 404 Not Found</title>
                ...
                <div class="row no-gutters align-items-center height-100vh">
                    <div class="col-lg-12">
                        <div class="error-content text-center">
                            ...
                            <h3 style="color: blue">Không tìm thấy trang yêu cầu</h3>
                            <div class="error-btn btn-hover">
                                <a class="bg-black-hover" href="${pageContext.request.contextPath}/">Quay lại trang chủ</a>
                            </div>
                        </div>
                    </div>
                </div>
...
============================================ -->
    ...
    <script src="${pageContext.request.contextPath}/assets/js/plugins/svg-injector.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/jquery.nice-select.min.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/mouse-parallax.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/images-loaded.js"></script>
    <script src="${pageContext.request.contextPath}/assets/js/plugins/isotope.js"></script>
